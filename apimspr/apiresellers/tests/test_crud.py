...
def test_get_reseller_by_invalid_api_key(db):
    # Aucun revendeur n'est ajouté ici

    # Act : appel avec une clé API inexistante
    result = get_reseller_by_api_key(db, "INVALID_KEY")

    # Assert : on doit obtenir None
